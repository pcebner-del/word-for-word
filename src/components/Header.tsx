...
export default function Header() {
  ...
  return (
    <header className="bg-primary text-cream sticky top-0 z-50 shadow-md">
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 group">
          <div className="flex flex-row gap-[3px]">
            <div className="w-[5px] h-6 bg-[#555555] rounded-sm" />
            <div className="w-[5px] h-6 bg-german-red rounded-sm" />
            <div className="w-[5px] h-6 bg-german-gold rounded-sm" />
          </div>
